...
(function (angular, buildfire, window) {
  angular
    ...
    .config(['$routeProvider', '$httpProvider', '$compileProvider', '$sceDelegateProvider', function ($routeProvider, $httpProvider, $compileProvider, $sceDelegateProvider) {
    ...
    .run(['Location', '$location', '$rootScope', '$http', 'RewardCache', 'ViewStack', 'Context',
      function (Location, $location, $rootScope, $http, RewardCache, ViewStack, Context) {
